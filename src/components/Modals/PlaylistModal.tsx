...
useEffect(() => {
  ...
  const handleSubmit = () => {
    ...
    if (mode === 'create') {
      ...
      renamePlaylist(playlist.id, value)
    }
            ...
            >
              ...
              <div className="flex items-center justify-between p-6 border-b border-[var(--color-border)]">
                <div className="flex items-center gap-3">
                  <div className="w-11 h-11 rounded-xl bg-[var(--color-glass-mid)] flex items-center justify-center">
                    <ListMusic
                      size={18}
              ...
              <div className="p-6">
                ...
                <input
                  ...
                  outline-none
                  focus:border-[var(--color-dynamic-1)]
                  transition
                "
                />
              </div>
