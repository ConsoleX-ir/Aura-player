...
import { Music2, Heart, ListMusic, Plus, FolderOpen, Loader2, ChevronRight, Settings as SettingsIcon } from 'lucide-react'
...
export function Sidebar() {
  const { playlists, activeView, setActiveView, setSelectedPlaylistId,
    selectedPlaylistId, favorites, library } = usePlayerStore()
