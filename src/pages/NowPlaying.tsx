...
export function NowPlaying() {
  // Narrow selectors — this view legitimately needs progress/duration for
  // the seek bar, but the previous full-store subscribe also re-rendered it
  // on unrelated changes (e.g. importing songs into the library elsewhere).
